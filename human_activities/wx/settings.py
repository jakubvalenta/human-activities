...
class Settings(wx.Dialog):
    ...
    def _init_window(self):
        ...
        self._border_sizer.Add(
            self._panel, proportion=1, flag=wx.EXPAND | wx.ALL, border=10
        )
    ...
    def _init_dialog_buttons(self):
        ...
        self._border_sizer.Add(
            button_sizer, flag=wx.EXPAND | wx.TOP | wx.BOTTOM, border=10
        )
    ...
    def _add_widgets(self):
        ...
        self._sizer.Add(label, flag=wx.ALL, border=5)
        self._sizer.Add(
            self._threshold_days_ago_control, flag=wx.ALL, border=5
        )
        label = create_label(self._panel, texts.SETTINGS_MODE)
        self._sizer.Add(label, flag=wx.ALL, border=5)
        self._sizer.Add(
            self._mode_radios[MODE_ROOT_PATH], flag=wx.ALL, border=5
        )
